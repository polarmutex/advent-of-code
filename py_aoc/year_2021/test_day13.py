...
from py_aoc.year_2021.day13 import INPUT_S, parse, INPUT_GITHUB, INPUT_GOOGLE, INPUT_TWITTER, INPUT_REDDIT, part1, part2
...
def test_part2_example(example) -> None:
    assert part2(example) == 103


def test_part1_github(github) -> None:
    assert part1(github) == 814
