...
use aoc_traits::{days::Day1, ParseInput, Part1, Part2, Solution};

use super::AdventOfCode2021;

impl aoc_traits::MissingPartOne<Day1> for AdventOfCode2021<Day1> {}
/*
...
impl aoc_traits::MissingPartTwo<Day1> for AdventOfCode2021<Day1> {}
/*
