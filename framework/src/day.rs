...
impl ToResult for i32 {
    type Output = i32;
    fn to_result(self) -> Result<i32, anyhow::Error> {
        Ok(self)
    }
}
...
impl ToResult for i64 {
    type Output = i64;
    fn to_result(self) -> Result<i64, anyhow::Error> {
        Ok(self)
    }
}
...
impl ToResult for MulSubmission<u64> {
    type Output = MulSubmission<u64>;
    fn to_result(self) -> Result<MulSubmission<u64>, anyhow::Error> {
        Ok(self)
    }
}
